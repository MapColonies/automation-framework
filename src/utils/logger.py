...
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))  # Moving up to the project root
...
LOG_FILE: str = os.path.join(LOG_DIR, f"automation_{datetime.now().strftime('%Y-%m-%d')}.log")
